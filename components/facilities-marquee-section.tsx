...
export default function FacilitiesMarqueeSection() {
  return (
    <section className="w-full py-24 bg-gradient-to-b from-[#f0f7ff] to-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-4">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#1a365d] mb-4">Everything You Need to Succeed</h2>
      ...
      <div className="relative mb-6">
        <div className="flex gap-6 animate-marquee">
          {[...facilities, ...facilities].map((facility, index) => (
            <div
              key={index}
              className="flex-shrink-0 w-[300px] bg-white rounded-2xl p-6 border border-gray-100 shadow-sm"
            >
              <div className="w-12 h-12 rounded-xl bg-[#0E74D2]/10 flex items-center justify-center text-[#0E74D2] mb-4">
                {facility.icon}
              </div>
              <h3 className="font-semibold text-[#1a365d] mb-1">{facility.title}</h3>
              <p className="text-sm text-[#4a5568]">{facility.description}</p>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="bg-[#1a365d] rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
